...
class DataIngestion:
    ...
    def download_sales_data(self) -> str:
        try:
            ...
            raise SalesException(sys,e) from e 
    ...
    def split_data_as_train_test(self) -> DataIngestionArtifact:
        try:
            ...
            sales_data_frame["income_cat"] = pd.cut(
                sales_data_frame["median_income"],
            ...
            for train_index,test_index in split.split(sales_data_frame, sales_data_frame["income_cat"]):
                strat_train_set = sales_data_frame.loc[train_index].drop(["income_cat"],axis=1)
                strat_test_set = sales_data_frame.loc[test_index].drop(["income_cat"],axis=1)
